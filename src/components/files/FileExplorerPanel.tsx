      ...
      >
        {entry.isDir ? (
          <>
            ...
            />
            {expanded ? (
              <IconFolderOpen size={14} className="shrink-0 text-miro-amber" />
            ) : (
              <IconFolder size={14} className="shrink-0 text-miro-amber" />
            )}
          </>
        ) : (
          <>
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="flex items-center gap-2 border-b border-miro-border/20 px-3 py-2">
        <IconFolder size={14} className="text-miro-amber" />
