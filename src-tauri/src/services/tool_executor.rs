...
impl BuiltinToolExecutor {
    ...
    pub fn new_with_disabled(disabled_tools: HashSet<String>) -> Self {
        ...
        executor.register_parallel_branch_fork();
...
// ============================================================================
// Parallel Branch Fork Tool (v1.5.0)
// ============================================================================

impl BuiltinToolExecutor {
    fn register_parallel_branch_fork(&mut self) {
        let definition = ToolDefinitionDto {
            tool_type: "function".to_string(),
            function: ToolFunctionDefDto {
        ...
        self.register_async(definition, |args, ctx| {
            Box::pin(async move {
